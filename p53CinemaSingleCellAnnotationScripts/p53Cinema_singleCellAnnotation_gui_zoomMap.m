...
function [f] = p53Cinema_singleCellAnnotation_gui_zoomMap(master)
...
if master.obj_imageViewer.image_width/master.obj_imageViewer.image_height > 1
    ...
    hwidthaxes = 200/master.ppChar(1);
    hheightaxes = 200*master.obj_imageViewer.image_height/master.obj_imageViewer.image_width/master.ppChar(2);
else
    % then maximize the height
    hheightaxes  = 200/master.ppChar(2);
    hwidthaxes  = 200*master.obj_imageViewer.image_width/master.obj_imageViewer.image_height/master.ppChar(1);
end
%% Create the figure
%
fx = 10;
