...
classdef p53Cinema_singleCellAnnotation_object_master < handle
    properties
        data;
        obj_imageViewer;
        obj_fileManager;
    ...
    methods
        function obj = p53Cinema_singleCellAnnotation_object_master()
            %%
            ...
            obj.obj_fileManager = p53Cinema_singleCellAnnotation_object_fileManager(obj);
        end
        function initializeImageViewer(obj)
            if(~isempty(obj.obj_imageViewer))
                obj.obj_imageViewer.delete;
            end
            obj.obj_imageViewer = p53Cinema_singleCellAnnotation_object_imageViewer(obj);
