classdef CentroidTimeseries_nonLinked < handle
    ...
    methods
        function obj = CentroidTimeseries_nonLinked(maxTimepoint, allocationSize)
        ...
        function cell_id = getAvailableCellId(obj, timepoint)
            cell_id = find(obj.singleCells(timepoint).point(:,1) == 0, 1, 'first');
