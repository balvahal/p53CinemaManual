function [] = SEGMENTATION_measureSinglePositions(database, rawDataPath, segmentDataPath, outputPath, measurementChannels, segmentationChannel)
...
for i=1:length(uniqueGroups)
    ...
    for s=1:length(uniquePositions)
        ...
        measurements = SEGMENTATION_getIntensityMeasurements(subDatabase(subDatabase.position_number == uniquePositions(s),:), rawDataPath, segmentDataPath, measurementChannels, segmentationChannel);
