...
hbuttonGroupTracking = uibuttongroup('Units','characters',...
    'Position',[hx + hmargin + hwidth, hy - 2*hheight, hwidth * 1.5, hheight * 3.3],...
    'parent',f, 'SelectionChangeFcn',@trackingModeChange_Callback);
hradiobuttonDontPropagate = uicontrol('Style','radiobutton','Units','characters',...
    'FontSize',10,'FontName','Arial','HorizontalAlignment','right',...
    'String','Frame-by-frame','Position',[0,hheight*2,hwidth*1.2,hheight],...
    'Enable', 'on','parent',hbuttonGroupTracking, 'Tag', 'SingleFramePropagate');
hradiobuttonForwardPropagate = uicontrol('Style','radiobutton','Units','characters',...
    'FontSize',10,'FontName','Arial','HorizontalAlignment','right',...
    'String','Propagate forwards','Position',[0,hheight,hwidth*1.2,hheight],...
    'Enable', 'on','parent',hbuttonGroupTracking, 'Tag', 'ForwardPropagate');
hradiobuttonBackwardsPropagate = uicontrol('Style','radiobutton','Units','characters',...
    'FontSize',10,'FontName','Arial','HorizontalAlignment','right',...
    'String','Propagate backwards','Position',[0,0,hwidth*1.2,hheight],...
    'Enable', 'on','parent',hbuttonGroupTracking, 'Tag', 'BackwardsPropagate');

%% Layout: Load and save tracking information
hy = hy - hheight * 3 - hmargin_short;
...
htextExclusionRadius = uicontrol('Style','text','Units','characters',...
    'FontSize',10,'FontName','Arial','HorizontalAlignment','right',...
    'String','Exclusion radius','Position',[hx, hy, hwidth, hheight],...
    'parent',f);
...
handles.hradiobuttonForwardPropagate = hradiobuttonForwardPropagate;
handles.hradiobuttonBackwardsPropagate = hradiobuttonBackwardsPropagate;
...
%
    ...
    function trackingModeChange_Callback(~,~)
        master.obj_imageViewer.obj_cellTracker.trackPropagateMode = get(get(hbuttonGroupTracking, 'SelectedObject'), 'Tag');
    end
