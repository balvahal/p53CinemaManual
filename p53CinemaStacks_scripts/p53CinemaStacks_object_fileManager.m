%%
%
classdef p53CinemaStacks_object_fileManager < handle
    properties
        gui_fileManager;
        master;
    ...
    methods
        %% Constructor
        function obj = p53CinemaStacks_object_fileManager(master)
            obj.gui_fileManager = p53CinemaStacks_gui_fileManager(master);
            obj.master = master;
        end
