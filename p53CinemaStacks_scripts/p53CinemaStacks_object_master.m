...
classdef p53CinemaStacks_object_master < handle
    properties
        data;
        obj_imageViewer;
        obj_fileManager;
    ...
    methods
        function obj = p53CinemaStacks_object_master()
            %%
            ...
            %% Load settings
            %
            obj.data = p53CinemaStacks_object_data;
            obj.data.outputdirectory = obj.outputdirectory;
            %% Start all guis
            %
            
            obj.obj_fileManager = p53CinemaStacks_object_fileManager(obj);
        end
        function initializeImageViewer(obj)
            ...
            obj.obj_imageViewer = p53CinemaStacks_object_imageViewer(obj);
