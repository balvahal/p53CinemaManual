...
classdef p53CinemaStacks_object_imageViewer < handle
    properties
        gui_imageViewer;
        gui_contrast;
        gui_zoomMap;
    ...
    methods
        %% object constructor
        %
        function obj = p53CinemaStacks_object_imageViewer(master)
            obj.master = master;
            ...
            obj.obj_cellTracker = p53CinemaStacks_object_cellTracker(master);
            %% Preload images
            %
            ...
            referenceImage = imresize(obj.readImage(12), obj.imageResizeFactor);
            %referenceImage = imresize(obj.readImage(1), obj.imageResizeFactor);
            normalizationFactor = double(quantile(referenceImage(:), 0.9999));
...
%                 obj.imageBuffer = uint8(bitshift(uint16(obj.imageBuffer), -8));
        ...
        function obj = launchImageViewer(obj)
            %% Launch the gui
            %
            obj.gui_imageViewer = p53CinemaStacks_gui_imageViewer(obj.master, obj.master.obj_fileManager.maxHeight);
            obj.gui_contrast = p53CinemaStacks_gui_contrast(obj.master);
            obj.gui_zoomMap = p53CinemaStacks_gui_zoomMap(obj.master);
            obj.setFrame(1);
            obj.autoContrast;
        end
