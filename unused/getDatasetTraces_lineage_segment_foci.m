function measurements = getDatasetTraces_lineage_segment_foci(database, rawdata_path, tracking_path, segment_path, measurementChannel, segmentationChannel)
    ...
    for i=1:length(trackingFiles)
        ...
        traces = getSingleCellTrace_withSegmentation_foci(rawdata_path, segment_path, database, selectedGroup, selectedPosition, measurementChannel, segmentationChannel, centroidsTracks);
