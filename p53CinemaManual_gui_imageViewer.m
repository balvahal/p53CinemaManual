...
trackedCellsPatch = patch('Parent',haxesImageViewer,'XData',[],'YData',[],...
...
selectedCellPatch = patch('Parent',haxesImageViewer,'XData',[],'YData',[],...
    'EdgeColor','none','FaceColor','none','MarkerSize',10,...
    'Marker','o','MarkerEdgeColor',[1,0.75,0],'MarkerFaceColor',[1,0,0],...
    'Parent',haxesImageViewer,'LineSmoothing', 'off');

cellsInRangePatch = patch('Parent',haxesImageViewer,'XData',[],'YData',[],...
    'EdgeColor','none','FaceColor','none','MarkerSize',1,...
    'Marker','o','MarkerEdgeColor',[1,0.75,0],'MarkerFaceColor',[1,0,0],...
    'Parent',haxesImageViewer,'LineSmoothing', 'off');

closestCellPatch = patch('Parent',haxesImageViewer,'XData',[],'YData',[],...
