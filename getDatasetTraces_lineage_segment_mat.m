function measurements = getDatasetTraces_lineage_segment_mat(database, rawdata_path, tracking_path, segment_path, measurementChannel, segmentationChannel, measurementParameter)
    ...
    for i=1:length(trackingFiles)
        ...
        traces = getSingleCellTrace_withSegmentation_matFormat(rawdata_path, segment_path, database, selectedGroup, selectedPosition, measurementChannel, segmentationChannel, centroidsTracks, measurementParameter);
