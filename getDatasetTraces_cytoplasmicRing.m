function measurements = getDatasetTraces_cytoplasmicRing(database, rawdata_path, tracking_path, segment_path, measurementChannel, segmentationChannel)
    ...
    for i=1:length(trackingFiles)
        ...
        traces = getSingleCellTrace_cytoplasmicRing(rawdata_path, segment_path, database, selectedGroup, selectedPosition, measurementChannel, segmentationChannel, centroidsTracks);
