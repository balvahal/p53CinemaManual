...
%%% Other Notes
%
function [] = SEGMENTATION_segmentDataset_flatfield(database, rawDataPath, segmentDataPath, channel, ffpath)
        ...
        parfor k=1:length(files)
            ...
            if(~exist(fullfile(segmentDataPath,outputFilename{1}), 'file'))
                try
                    ...
                    [Objects, Centroids] = SEGMENTATION_identifyPrimaryObjectsGeneral(IM, 'AreaThreshold', 500);
