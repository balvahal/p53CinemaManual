function [singleCellTracks, background_trace] = getSingleCellTracks2_withBackground(rawdatapath, database, group, position, channel, centroids, ff_offset, ff_gain)
    ...
    background_trace = zeros(1, numTimepoints);
    progress = 0;
    for i=1:numTimepoints
        ...
        [YFP_background, background_value] = imbackground(YFP, 10, 100);
        background_trace(:,i) = background_value;
